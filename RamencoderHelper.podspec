#
# Be sure to run `pod spec lint RamencoderHelper.podspec' to ensure this is a
# valid spec.
#
...
#
Pod::Spec.new do |s|
  s.name         = "RamencoderHelper"
  s.version      = "0.0.1"
  s.summary      = "RamencoderHelper's helper classes for iOS project."
  # s.description  = <<-DESC
  #                   An optional longer description of RamencoderHelper
  #
  #                   * Markdonw format.
  ...
  #
  s.author       = { "Zitao" => "caoer115@gmail.com" }
  # s.authors      = { "Zitao" => "caoer115@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Zitao', 'other author'

  # Specify the location from where the source should be retreived.
  #
  s.source       = { :git => "https://github.com/nanaimostudio/RamencoderHelper.git" }
